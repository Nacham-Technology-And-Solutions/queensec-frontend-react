        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            {{-- <li class="nav-main-item{{ request()->is('vendors*') ? ' open' : '' }}">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('vendors/create') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">Add Vendor</span>
                  </a>
                </li>
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('vendors') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">View Vendors</span>
                  </a>
                </li>
              </ul>
            </li> --}}
            ...
            <li class="nav-main-item{{ request()->is('enforcers*') ? ' open' : '' }}">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                ...
                <span class="nav-main-link-name">Enforcers</span>
              </a>
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
            ...
            <li class="nav-main-item{{ request()->is('investors*') ? ' open' : '' }}">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('investors/create') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">Add Investor</span>
                  </a>
                </li>
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('investors') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">View Investors</span>
                  </a>
                </li>
              </ul>
            </li> --}}
            ...
            <li class="nav-main-heading">Platform Core</li>

            <!-- Minerals Section -->
            <li class="nav-main-item{{ request()->is('minerals*') ? ' open' : '' }}">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                <i class="nav-main-link-icon si si-grid"></i>
                <span class="nav-main-link-name">Minerals</span>
              </a>
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
            ...
            <!-- Haulers Section -->
            <li class="nav-main-item{{ request()->is('haulers*') ? ' open' : '' }}">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                <i class="nav-main-link-icon si si-basket-loaded"></i>
                <span class="nav-main-link-name">Haulers</span>
              </a>
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
            ...
            <li class="nav-main-heading">Business Logic</li>
            ...
            <li class="nav-main-item{{ request()->is('orders*') ? ' open' : '' }}">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('orders/track') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">Track Orders</span>
                  </a>
                </li>
                <li class="nav-main-item">
            ...
            <!-- Payments Section -->
            <li class="nav-main-item{{ request()->is('payments*') ? ' open' : '' }}">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('payments/track') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">Track Payment</span>
                  </a>
                </li>
                <li class="nav-main-item">
            ...
            <li class="nav-main-heading">Moderations</li>

            <!-- Notifications Section -->
            <li class="nav-main-item{{ request()->is('notifications*') ? ' open' : '' }}">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                <i class="nav-main-link-icon si si-users"></i>
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('notifications/create') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">Send Notifications</span>
                  </a>
                </li>
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('notifications/') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">View Notifications</span>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-main-item{{ request()->is('ads*') ? ' open' : '' }}">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                <i class="nav-main-link-icon si si-users"></i>
                <span class="nav-main-link-name">In App Banners</span>
              </a>
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('ads/create') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">Add Ads</span>
                  </a>
                </li>
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('ads/') ? ' active' : '' }}" href="#">
                    <span class="nav-main-link-name">View Ads</span>
                  </a>
                </li>
              </ul>
            </li>
