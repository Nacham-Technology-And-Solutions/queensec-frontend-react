...
<html lang="en">
  <head>
    ...
    <!-- Open Graph Meta -->
    <meta property="og:title" content="Tax Payer Login ">
    <meta property="og:site_name" content="QueSecGlobal">
    <meta property="og:description" content="Tax Payer Login Page">
  ...
  <body>
                ...
                <div class="block block-rounded mb-0">
                  <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                      <a class="btn-block-option fs-sm" href="{{route('forgot_password') }}">Forgot Password?</a>
    ...
    <div class="py-3">
        <div class="mb-4">
            <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="login-username" placeholder="Enter your Truck Plate Number eg ABC175AZ">
        </div>
        <div class="mb-4">
