            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                <div class="flex-grow-1">
                    ...
                    <h2 class="fs-base lh-base fw-medium text-muted mb-0">
                        Control everything concerning admin admins.
                    </h2>
                </div>
                <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">
                            <a class="link-fx" href="{{ route('admins.index') }}">Admin Users</a>
    ...
    <div class="content d-flex justify-content-center align-items-center">
        <div class="block block-rounded" style="width: 50%; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
            <div class="block-header block-header-default">
                <h3 class="block-title text-center">Create Admin User</h3>
            </div>
            <div class="block-content">
                ...
                <form action="{{ route('admins.store') }}" method="POST" style="padding: 15px;">
                    @csrf
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="middle_name" name="middle_name"
                                    placeholder="Middle Name" value="middle_name">
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" class="form-control" id="password" name="password"
                                    placeholder="Password Input" value="password">
                            </div> 
                            <div class="mb-4">
