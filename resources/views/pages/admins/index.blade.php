                    ...
                    <tbody>
                        @foreach ($admins as $admin)
                            <tr>
                                ...
                                <td>
                                    <form
                                        action="{{ $admin->active == 1 ? route('admins.disable', $admin->id) : route('admins.enable', $admin->id) }}"
                                        method="POST" style="display:inline;">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit"
                                            class="btn btn-{{ $admin->active == 1 ? 'warning' : 'success' }}  btn-sm">
                                            {{ $admin->active == 1 ? 'Disable' : 'Enable' }}
                                        </button>
                                    </form>
