    ...
    <div class="content d-flex justify-content-center align-items-center">
        <div class="block block-rounded" style="width: 50%; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
            <div class="block-header block-header-default">
                <h3 class="block-title text-center">Edit State</h3>
            </div>
            <div class="block-content">
                ...
                <form action="{{ route('locations.update', $locState->id) }}" method="POST" style="padding: 15px;">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="State Name" value="{{ old('name', $locState->name) }}">
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="code">Code</label>
                                <input type="text" class="form-control" id="code" name="code"
                                    placeholder="State Code" value="{{ old('code', $locState->code) }}">
                            </div>                            
                        </div>
                    </div>
