    ...
    <div class="content d-flex justify-content-center align-items-center">
        <div class="block block-rounded" style="width: 50%; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
            ...
            <div class="block-content">
                ...
                <form action="{{ route('locations.update', $locLocality->id) }}" method="POST" style="padding: 15px;">
                    @csrf
                    @method('PUT')
                    
                    <input type="text" class="form-control" id="locType" name="locType" value="locality" hidden>
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="loc_state_id" name="loc_state_id">
                                        ...
                                        <option value="{{ $locLocality->locState()->id }}">{{ $locLocality->locState()->name }}</option>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Locality Name" value="{{ old('name', $locLocality->name) }}">
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="code">Code</label>
                                <input type="text" class="form-control" id="code" name="code"
                                    placeholder="Locality Code" value="{{ old('code', $locLocality->code) }}">
                            </div>                            
                        </div>
                    </div>
