    ...
    <div class="content d-flex justify-content-center align-items-center">
        <div class="block block-rounded" style="width: 50%; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
            <div class="block-header block-header-default">
                <h3 class="block-title text-center">Create Mineral</h3>
            </div>
            <div class="block-content">
                ...
                <form action="{{ route('minerals.store') }}" method="POST" style="padding: 15px;">
                    @csrf
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control" id="advalorem" name="advalorem"
                                    placeholder="Advalorem" value="{{ old('advalorem') }}">
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control" id="royalty_rate" name="royalty_rate" placeholder="Royalty Rate"
                                    value="{{ old('royalty_rate') }}">
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="phone">Unit Measurement</label>
