                ...
                <div class="block-options">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-ecom-filters">
                            ...
                            <a class="dropdown-item d-flex align-items-center justify-content-between"
                                href="{{ route('payments.index', ['status' => 'completed'])}}">
                                completed
                                <span class="badge bg-warning rounded-pill">{{ $states['completed'] }}</span>
                            </a>
                            <a class="dropdown-item d-flex align-items-center justify-content-between"
                                href="{{ route('payments.index', ['status' => 'cancelled'])}}">
                                cancelled
                                <span class="badge bg-info rounded-pill">{{ $states['cancelled'] }}</span>
                            </a>
                            {{-- <a class="dropdown-item d-flex align-items-center justify-content-between"
                                href="{{ route('payments.index', ['payment_type' => 'full'])}}">
                                full
                    ...
                    <div class="mb-4">
                        <div class="input-group">
                            <input type="number" class="form-control form-control-alt" id="search"
                                name="search" placeholder="Search all payments..">
                    ...
                    <table class="table table-borderless table-striped table-vcenter">
                        <thead>
                            <tr>
                                ...
                                <th>Type</th>
                                <th class="d-none d-xl-table-cell text-center">Mineral</th>
