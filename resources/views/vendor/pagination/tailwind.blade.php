        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            ...
            <div>
                <ul class="pagination pagination-sm justify-content-end mt-2">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
                        <li aria-disabled="true" aria-label="{{ __('pagination.previous') }}" class="page-item">
                            <a class="page-link" href="javascript:void(0)" tabindex="-1" aria-label="Previous">
                                Prev
                            </a>
                        </li>
                    @else
                        <li class="page-item" aria-label="{{ __('pagination.previous') }}">
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                ...
                                <li class="page-item active" aria-label="{{ __('Go to page :page', ['page' => $page]) }}">
                    ...
                    {{-- Next Page Link --}}
                    @if ($paginator->hasMorePages())
                        <li class="page-item" aria-label="{{ __('pagination.next') }}">
